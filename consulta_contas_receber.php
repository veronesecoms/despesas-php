<?php include_once("registra_recebimento.php");
	$grupo = filtraRecebimentos();
...
<!-- Static navbar -->
		...
		<div class="container">
		<div class="thumb">
		<a href="pdf_contas_receber.php" target="_blank">
		...
		<div class="container divconsultas">
			...
			<thread>
				<tr>
					...
					<td align="center" style="color:white; font-size: 17px; font-family:Tahoma">Cliente</td>
			...
			<tbody>
				...
				foreach($grupo as $conta){
				 ?>
					...
					<tr>
						...
						<td>
							 <form align="center" action="alterar_conta_receber.php" name="alterar" method="POST">
						...
						<td>
							...
							<form align="center" action="registra_recebimento.php" name="excluir" method="POST">
								<input type="hidden" name="id" value=<?=$conta["id"]?> />
				...
				echo('Ainda não existem entradas cadastradas');
			}
