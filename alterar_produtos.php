...
$produtos = selectIdProdutos($_POST["id"]);
			...
			<div class="col-md-6">
				<form name="dadosProdutos" action="registra_produto.php" method="POST">
					<div class="form-group">
						<label style="color:#E4CDAC; font-size: 17px; font-family:Arial" for="descricao">Descricao</label>
						 <textarea class="form-control" rows="2" id="descricao" name="descricao"><?=$produtos["descricao"]?></textarea>
					</div>

					<div class="form-group">
						<label style="color:#E4CDAC; font-size: 17px; font-family:Arial" for="custo">Custo</label>
						<input type="text" class="form-control" id="custo" value=<?=$produtos["custo"]?> name="custo" >
					</div>

					<div class="form-group">
						<label style="color:#E4CDAC; font-size: 17px; font-family:Arial" for="precovenda">Preço de Venda</label>
						<input type="text" class="form-control" id="precovenda" value=<?=$produtos["preco_venda"]?> name="precovenda" >
					</div>
					...
					<div class="form-group">
						<input type="checkbox" name="fg_ativo" id="fg_ativo" <?php
							...
							?>><span style="color:#E4CDAC; font-size: 17px; font-family:Arial"> Ativo</span>
						<br> <br>
					...
					<div class="form-group">
						<button onclick="msgSucesso()" type="submit" class="btn customizado btn-roxo btn-lg">Alterar</button>
					</div>
