		...
		<form name="dadosConta" action="registra_conta.php" method="POST">
			...
			<div class="form-group">
				...
				<select class="form-control" name="select_fornecedores">
					<?php
					$idselecionado = $pessoa['cidade'];
					?>
					<option value = <?=$idselecionado?> > <?=$pessoa["nomecidade"]?></option>
					<?php
					$result_fornecedores = "SELECT * FROM cidades";
			...
			<div class="form-group">
				...
				<input type="date" class="form-control" value=<?=$conta["datavencimentoformatada"]?> id="datavencimento" name="datavencimento" required>
			</div>
